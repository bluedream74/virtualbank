    ...
    <section role="main" class="content-body">
        ...
        <header class="page-header">
            ...
            <div class="right-wrapper pull-right">
                <a href="{{ url('admin/user/create') }}" class="btn btn-danger" style="margin: 7px 10px">新規加盟店登録</a>
        ...
        <section class="panel">
            ...
            <div class="panel-body">
                ...
                <div class="filter mb-xlg" style="padding: 15px; border: 1px solid #444;">
                    ...
                    <form class="form-horizontal" action="{{ url('admin/user/search/') }}" enctype="multipart/form-data" method="post" id="searchForm">
                        ...
                        <div class="row" style="padding: 0">
                            ...
                            <div class="col-sm-4 mt-md">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input id="u_name" name="u_name" class="form-control" value="{{  $data['u_name'] }}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 mt-md">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <label>電話番号</label>
                                        <input type="number" id="u_tel" name="u_tel" class="form-control" value="{{ $data['u_tel'] }}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 mt-md">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="email" id="u_email" name="u_email" class="form-control" value="{{  $data['u_email'] }}" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-4 mt-md">
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <input type="text" id="u_holdername_fu" name="u_holdername_fu" class="form-control" value="{{  $data['u_holdername_fu'] }}" onkeypress="toKata(this)"/>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <select class="form-control" id="u_status" name="u_status">
                                            <option value=""></option>
                                            <option value="審査中" @if($data['u_status'] == '審査中') selected @endif>審査中</option>
                                            <option value="契約中" @if($data['u_status'] == '契約中') selected @endif>契約中</option>
                                            <option value="解約" @if($data['u_status'] == '解約') selected @endif>解約</option>
                                            <option value="休止" @if($data['u_status'] == '休止') selected @endif>休止</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                        ...
                        @foreach($list as $item)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($item->shops > 0)
                                        <a href="{{ url('admin/user/shops/' . $item->id)}}" style="color: white;padding: 5px 10px; border-radius: 15px;background-color: orange">{{ $item->shops }}</a>
                                    @else
                                        0
                                    @endif
                                </td>
...
@section('page_js_vendor')
    ...
    <script src="{{ asset('public/admin/js/views/user.js') }}"></script>
    ...
    <script>
        ...
        $( document ).ready(function() {
            ...
            $('select[name="user_datatable_length"]').on('change', function() {
                ...
                window.location.href = '{{ url('/admin/user/') }}' + '?' + $('#searchForm').serialize();
            });
        });
