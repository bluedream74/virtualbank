...
@section('title', '店舗の決済一覧 | Virtual Bank')
...
@section('content')
    ...
    <section role="main" class="content-body">
        ...
        <header class="page-header">
            <div class="row">
                <div class="col-sm-4">
                    <h2><i class="fa fa-home"></i>&nbsp;&nbsp;店舗の決済一覧</h2>
                </div>
                <div class="form-group" id="search_box">
                    <form method="post" action="{{ url('merchant/transaction/shop') }}" id="searchForm" style="float: left;;">
                        <label>決済期間</label>
