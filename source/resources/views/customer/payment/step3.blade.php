...
@if($status == '契約中')
    <div class="top-container" id="paymentForm">
        ...
        <form class="form-horizontal" action="{{ url('payment/step3') }}" enctype="multipart/form-data" method="post" id="inputForm">
            ...
            <div id="inputContainer">
                ...
                <div id="shopname" class="mt-xs form-group">
                    ...
                    <p class="medium"><strong>{{ $support_name }}</strong></p>
                    <p class="small mb-md">クレジットカード利用明細書に記載される請求名です</p>

                    <p class="large">ご利用店舗名(Shop Name)</p>
                    <p class="medium"><strong>{{ $m_name }}</strong></p>
                    ...
                    <input type="hidden" name="supplier" value="{{ $support_name }}" />
                ...
                <div id="card-info">
                    ...
                    <input type="hidden" name="cardtype_id" id="cardtype_id" value="{{ $cardtype_id }}" required  />
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <select class="form-control" name="card_exp_year" id="card_exp_year" required="" autocomplete="cc-exp-year">
                                ...
                                @for($year=date('Y');$year<2100;$year++)
                ...
                <!-- links -->
                <div id="links">
                    <a class="page-link hidden" href="{{ url('terms') }}"><i class="fa fa-angle-right"></i>&nbsp;&nbsp;利用規約</a>
                    <a class="page-link hidden" href="{{ url('privacy-policy') }}"><i class="fa fa-angle-right"></i>&nbsp;&nbsp;個人情報保護規約</a>
