    ...
    <div class="top-container">
        <div class="inner">
                ...
                <tbody>
                    <tr>
                        <td class="text-center detail">
                            カード利用明細の請求名<br><strong>{{ $support_name }}</strong><br>クレジットカード利用明細に記載される<br>請求名です
                        </td>
                    </tr>
                    <tr>
                        <td class="text-center detail">
                            ご利用店舗名<br><strong>{{ $m_name }}</strong><br>店舗名は、請求名として記載されません
                        </td>
                    </tr>
                </tbody>
            </table>
            ...
            <div class="text-center mt-md mb-md">
                <a href="{{ url('/payment/step3/' . $path) }}" class="btn btn-default btn-gold btn-next disabled" id="btn-next">次へ</a>
            </div>
