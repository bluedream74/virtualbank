    ...
    <div role="main" class="main">
        ...
        <header id="page-top">
            ...
            <div class="inner-header pt-md">
                <a href="{{ url('/group') }}" class="logo-link" style="text-align: left;"><img src="{{ asset('public/customer/img/logo.png') }}" width="55%" style="max-width: 450px;"></a>
            </div>
        </header>

        <div class="text-center" style="margin-top: 80px;"><h2 style="font-weight: bold; color: white;">グループ・加盟店・店舗管理画面</h2></div>

        <div class="row" style="padding: 50px 10px 20px;">
            <div class="col-sm-4 col-sm-offset-4 col-xs-12">

                <form action="{{ url('/group/login') }}" method="post" class="input-form">
                    {{csrf_field()}}
            ...
            <div class="contact-box pt-lg mb-xlg">
                <div class="col-xs-12 p-none">
                    <div class="contact-info">
                        ...
                        <p>{{ $support_company }}</p>
                        <p><i class="fa fa-envelope"></i>&nbsp;{{ $support_email }}</p>
                        <p class="mb-sm"><i class="fa fa-phone-square"></i>&nbsp;{{ $support_phone }}</p>
                    </div>
                </div>
                <div class="col-xs-12 text-center">
