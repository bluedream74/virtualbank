<?php $__env->startSection('title', 'グループ・加盟店・店舗管理画面'); ?>
    ...
    <div role="main" class="main">
        ...
        <header id="page-top">
            ...
            <div class="inner-header pt-md">
                <a href="<?php echo e(url('/group')); ?>" class="logo-link" style="text-align: left;"><img src="<?php echo e(asset('public/customer/img/logo.png')); ?>" width="55%" style="max-width: 450px;"></a>
            </div>
        </header>
        ...
        <div class="row" style="padding: 50px 10px 20px;">
            <div class="col-sm-4 col-sm-offset-4 col-xs-12">
                ...
                <form action="<?php echo e(url('/group/login')); ?>" method="post" class="input-form">
