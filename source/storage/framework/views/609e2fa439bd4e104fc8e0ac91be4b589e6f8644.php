...
<body>
    ...
    <?php if(Auth::guard('merchant')->check()): ?>

        <section class="body">

            <?php echo $__env->make('merchant.layouts.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

            <div class="inner-wrapper">

                <?php echo $__env->make('merchant.layouts.sidebar-left', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

                <?php echo $__env->yieldContent('content'); ?>

            </div>

            <?php echo $__env->make('merchant.layouts.sidebar-right', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
