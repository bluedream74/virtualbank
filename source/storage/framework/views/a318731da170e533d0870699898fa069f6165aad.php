    ...
    <div class="top-container">
        <div class="inner">
                ...
                <tbody>
                        ...
                        <td width="85%">
                            <div class="row">
                                <div class="col-xs-5 pt-xs">
                                    <img src="<?php echo e(asset('public/customer/img/VISA.png')); ?>" width="100%" />
                                </div>
                        ...
                        <td width="85%">
                            <div class="row">
                                <div class="col-xs-5 pt-sm">
                                    <img src="<?php echo e(asset('public/customer/img/MASTERCARD.png')); ?>" width="100%" />
                                </div>
                    ...
                    <tr>
                        ...
                        <td width="85%">
                            <div class="row">
                                <div class="col-xs-5 pt-xs">
                                    <img src="<?php echo e(asset('public/customer/img/JCB.png')); ?>" width="100%" />
                                </div>
                    ...
                    <tr>
                        ...
                        <td width="85%">
                            <div class="row">
                                <div class="col-xs-5 pt-sm">
                                    <img src="<?php echo e(asset('public/customer/img/AMEX.png')); ?>" width="100%" />
                                </div>
            ...
            <div class="text-center mt-xlg">
                <a data-url="<?php echo e(url('/payment/step2/' . $path)); ?>" class="btn btn-default btn-gold btn-next disabled" onclick="goStep2(this)" id="btnNext">次へ</a>             
            </div>
