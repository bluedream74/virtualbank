	...
	(function() {
		var target = $('#gaugeBasic'),
			opts = $.extend(true, {}, {
				...
				colorStart: '#f3c41c', // Colors
				colorStop: '#f3c41c', // just experiment with them
